...
def add_args(parser):
    ...
    """
    parser.add_argument(
        "--N", type=int, default=10000, help="Number of neurons in the network"
    )

    parser.add_argument("--path_to_results", default="./results", type=str)

    parser.add_argument("--experiment_name", default="0", type=str)

    parser.add_argument("--path_to_mappings", default="./mappings/1", type=str)

    parser.add_argument("--path_to_visuals", default="./results/0/visuals", type=str)

    parser.add_argument("--path_to_network", default="./results/test.pkl", type=str)
